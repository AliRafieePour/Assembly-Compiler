from __config__ import ALONE_IN_LINE
...
def show_error(error_code: int, line_number: int):
    error_text_list = ["Unexpected Error\n",
                       ...
                       "Variable/function name can't be more than or less than 3 characters.\n",
    ...
    error_list.append("(line => {}) ERROR: ".format(line_number) + error_text_list[error_code])
    return 1
